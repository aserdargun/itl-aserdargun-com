...
Phase 1 presents the protocol and a conceptual hierarchy. It does not aggregate asset data, perform federated training, or transfer a model between applications.
